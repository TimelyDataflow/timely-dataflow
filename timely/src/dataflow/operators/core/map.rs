...
pub trait Map<S: Scope, C: IterableContainer> {
    ...
    where
        C2: SizableContainer + IterableContainer + PushInto<D2> + Data,
    ...
    where
        I: IntoIterator,
        C2: SizableContainer + IterableContainer + PushInto<I::Item> + Data,
        L: FnMut(C::Item<'_>)->I + 'static,
    ;
}

impl<S: Scope, C: IterableContainer + Data> Map<S, C> for StreamCore<S, C> {
