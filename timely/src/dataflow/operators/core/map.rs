...
pub trait Map<S: Scope, C: IterContainer> {
    ...
    where
        C2: SizableContainer + IterContainer + PushInto<D2> + Data,
    ...
    where
        I: IntoIterator,
        C2: SizableContainer + IterContainer + PushInto<I::Item> + Data,
        L: FnMut(C::Item<'_>)->I + 'static,
    ;
}

impl<S: Scope, C: IterContainer + Data> Map<S, C> for StreamCore<S, C> {
