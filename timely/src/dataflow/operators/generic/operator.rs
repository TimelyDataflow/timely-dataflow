...
pub trait Operator<G: Scope, D1: Container> {
    ...
    /// }
    /// ```
    fn unary_frontier<D2, B, L, P>(self, pact: P, name: &str, constructor: B) -> OwnedStream<G, D2>
    where
        D2: Container,
        B: FnOnce(Capability<G::Timestamp>, OperatorInfo) -> L,
        L: FnMut(&mut FrontieredInputHandleCore<G::Timestamp, D1, P::Puller>,
                 &mut OutputHandleCore<G::Timestamp, D2, PushOwned<G::Timestamp, D2>>)+'static,
    ...
    fn unary_notify<D2: Container,
            L: FnMut(&mut InputHandleCore<G::Timestamp, D1, P::Puller>,
                     &mut OutputHandleCore<G::Timestamp, D2, PushOwned<G::Timestamp, D2>>,
                     &mut Notificator<G::Timestamp>)+'static,
             P: ParallelizationContractCore<G::Timestamp, D1>>
             (self, pact: P, name: &str, init: impl IntoIterator<Item=G::Timestamp>, logic: L) -> OwnedStream<G, D2>;
    ...
    /// });
    /// ```
    fn unary<D2, B, L, P>(self, pact: P, name: &str, constructor: B) -> OwnedStream<G, D2>
    where
        D2: Container,
        B: FnOnce(Capability<G::Timestamp>, OperatorInfo) -> L,
        L: FnMut(&mut InputHandleCore<G::Timestamp, D1, P::Puller>,
    ...
    /// }).unwrap();
    /// ```
    fn binary_frontier<D2, D3, O, B, L, P1, P2>(self, other: O, pact1: P1, pact2: P2, name: &str, constructor: B) -> OwnedStream<G, D3>
    where
        D2: Container,
        D3: Container,
        O: StreamLike<G, D2>,
        ...
        L: FnMut(&mut FrontieredInputHandleCore<G::Timestamp, D1, P1::Puller>,
                 ...
                 &mut OutputHandleCore<G::Timestamp, D3, PushOwned<G::Timestamp, D3>>)+'static,
    ...
    fn binary_notify<D2: Container,
              ...
              L: FnMut(&mut InputHandleCore<G::Timestamp, D1, P1::Puller>,
                       ...
                       &mut OutputHandleCore<G::Timestamp, D3, PushOwned<G::Timestamp, D3>>,
                       &mut Notificator<G::Timestamp>)+'static,
              P1: ParallelizationContractCore<G::Timestamp, D1>,
              P2: ParallelizationContractCore<G::Timestamp, D2>>
            (self, other: O, pact1: P1, pact2: P2, name: &str, init: impl IntoIterator<Item=G::Timestamp>, logic: L) -> OwnedStream<G, D3>;
    ...
    /// });
    /// ```
    fn binary<D2, D3, O, B, L, P1, P2>(self, other: O, pact1: P1, pact2: P2, name: &str, constructor: B) -> OwnedStream<G, D3>
    where
        D2: Container,
        D3: Container,
        O: StreamLike<G, D2>,
...
impl<G: Scope, D1: Container, S: StreamLike<G, D1>> Operator<G, D1> for S {
    ...
    fn unary_notify<D2: Container,
            L: FnMut(&mut InputHandleCore<G::Timestamp, D1, P::Puller>,
                     ...
                     &mut Notificator<G::Timestamp>)+'static,
             P: ParallelizationContractCore<G::Timestamp, D1>>
             (self, pact: P, name: &str, init: impl IntoIterator<Item=G::Timestamp>, mut logic: L) -> OwnedStream<G, D2> {
    ...
    fn binary_notify<D2: Container,
              ...
              P1: ParallelizationContractCore<G::Timestamp, D1>,
              P2: ParallelizationContractCore<G::Timestamp, D2>>
            (self, other: O, pact1: P1, pact2: P2, name: &str, init: impl IntoIterator<Item=G::Timestamp>, mut logic: L) -> OwnedStream<G, D3> {
...
/// });
/// ```
pub fn source<G: Scope, D, B, L>(scope: &G, name: &str, constructor: B) -> OwnedStream<G, D>
where
    D: Container,
    B: FnOnce(Capability<G::Timestamp>, OperatorInfo) -> L,
    L: FnMut(&mut OutputHandleCore<G::Timestamp, D, PushOwned<G::Timestamp, D>>)+'static {
...
/// });
/// ```
pub fn empty<G: Scope, D: Container>(scope: &G) -> OwnedStream<G, D> {
