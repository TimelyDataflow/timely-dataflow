...
pub struct InputHandleCore<T: Timestamp, C: ProgressContainer, P: Pull<Message<T, C>>> {
...
pub struct FrontieredInputHandleCore<'a, T: Timestamp, C: ProgressContainer+'a, P: Pull<Message<T, C>>+'a> {
...
impl<T: Timestamp, C: ProgressContainer, P: Pull<Message<T, C>>> InputHandleCore<T, C, P> {
...
impl<'a, T: Timestamp, C: ProgressContainer, P: Pull<Message<T, C>>+'a> FrontieredInputHandleCore<'a, T, C, P> {
...
pub fn _access_pull_counter<T: Timestamp, C: ProgressContainer, P: Pull<Message<T, C>>>(input: &mut InputHandleCore<T, C, P>) -> &mut PullCounter<T, C, P> {
...
pub fn new_input_handle<T: Timestamp, C: ProgressContainer, P: Pull<Message<T, C>>>(
    pull_counter: PullCounter<T, C, P>, 
    internal: Rc<RefCell<Vec<Rc<RefCell<ChangeBatch<T>>>>>>, 
    summaries: Rc<RefCell<PortConnectivity<T::Summary>>>, 
    logging: Option<Logger>
