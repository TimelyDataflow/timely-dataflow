//! A list of independent dataflow computations.
...
// TODO: This should probably not be a scope, but just the allocation facilities.

pub struct List<S: Scope> {
    parent: S,
    dataflows: Rc<RefCell<Vec<Box<Operate<RootTimestamp>>>>>,
}

impl<A: Allocate> List<A> {
    ...
    ///
    /// The method is most commonly used with a dataflow probe, which indicates progress
