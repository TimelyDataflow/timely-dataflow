...
// pub fn initialize_networking_from_file(filename: &str, my_index: usize, threads: usize) -> Result<Vec<Binary>> {
//
...
//     }
//
//     initialize_networking(addresses, my_index, threads)
// }

pub fn initialize_networking(addresses: Vec<String>, my_index: usize, threads: usize) -> Result<Vec<Binary>> {
